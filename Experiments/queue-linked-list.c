...
/*
Output:
PS C:\Users\gagan\Documents\Data_Structure_And_Algorithm\Experiments> cd "c:\Users\gagan\Documents\Data_Structure_And_Algorithm\Experiments\" ; if ($?) { gcc queue-linked-list.c -o queue-linked-list } ; if ($?) { .\queue-linked-list }
Queue Front: 10
Queue Rear: 20
Queue Front: 40
Queue Rear: 50
